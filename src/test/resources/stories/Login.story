...
Scenario:  Simple test to give JBehave a test drive1
Given a file, a.log
When the caller loads the file as a byte array
Then the byte array that is returned contains the correct number of bytes.

Scenario:  Simple test to give JBehave a test drive2
Given a file, a.log
When the caller loads the file as a byte array
Then the byte array that is returned contains the correct number of bytes.

Scenario:  Simple test to give JBehave a test drive3
Given a file, a.log
When the caller loads the file as a byte array
Then the byte array that is returned contains the correct number of bytes.